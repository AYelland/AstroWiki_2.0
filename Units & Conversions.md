...
The average radius of the Sun, assuming a spherical shape.
...
$${\rm V} = {\rm A} \cdot \Omega = \frac{\rm Wb}{\rm s} = \frac{\rm W}{\rm A} = \frac{\rm J}{\rm C} = \frac{\rm eV}{e}$$
