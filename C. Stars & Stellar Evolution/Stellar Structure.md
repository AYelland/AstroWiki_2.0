...
$$\td{M_{r}}{r} = 4 \pi r^{2} \rho$$
where $M_{r}$ is mass enclosed within a spherical shell of inner radius ($r$), thickness ($\rd r$), and density ($\rho$). 
...
>
>The change in the enclosed mass of a sphere ($\rd M_{r}$), with respect to $r$, can be defined by the density ($\rho$) and the change in the enclosed volume ($\rd V_{\rm shell}$).
> $$
> \rd M_{r} = \rho \, \rd V_{\rm shell} = \rho \left( 4 \pi r^{2} \, \rd r \right)
> \hRightarrow \boxed{\td{M_{r}}{r} = 4 \pi r^{2} \rho}
> $$

### Hydrostatic Equilibrium
*(Also known as the **Pressure Profile**)*

$$\td{P}{r} = -\frac{G M_{r} \rho}{r^{2}} = -g(r) \rho$$
...
> ![[hydrostatic_equilibrium.png|align:center|300]]
>
> We need to balance the collapsing, gravitational force ($\rd F_{G}$) and the expanding, gas pressure ($\rd F_{P}$) on the two sides of the shell.
> 
> The gravitational force acting on the shell is:
> $$
> \rd F_{G} = - \frac{G M_{r} \, \rd m}{r^{2}}
> \hWhere
> \rd m \equiv \rho \, A \, \rd r
> $$
> 
> The gas pressure force acting on the shell is the difference between pressure pushing "down" from the outside and "out" from the inside. We define the minus sign such that $\rd F_{P}$ points inward.
> $$
> \rd F_{P} = - A \, \rd P = - \left( \td{P}{r} \right) \, \rd r \, A
> $$
> 
> The motion of the shell is then determined by Newton's 2nd Law
> $$
> \sum_{i} \vec{F}_{i} = m \vec{a} = m \, \tdd{r}{t} 
> \hRightarrow 
> \rd m \, \tdd{r}{t} = \rd F_{G} + \rd F_{P}
> $$
> At equilibirum, the system is static, such that the acceleration is zero. This provides us with the relationship:
> $$\rd m \, \underbrace{\tdd{r}{t}}_{= 0} = \left[ - \frac{G M_{r} \, \left( \rho \, A \, \rd r \right)}{r^{2}} \right] + \left[ - \td{P}{r} \, \rd r \, A \right]$$
> $$\boxed{\td{P}{r} = \frac{G M_{r} \, \rho}{r^{2}}}$$

### Conservation of Energy
*(Also known as the **Luminosity Profile**)*

$$\td{L}{r} = 4 \pi r^{2} \rho \, \left[ \varepsilon_{m} - T \td{S}{t} \right] \hWhere \varepsilon_{m} = \varepsilon_{n} + \cancelto{0}{\varepsilon_{\nu}}$$
...
> 
> With the density ($\rho$) and volume of the shell ($\rd V_{\rm shell}$), we can define the mass of the shell and determine the change in luminosity with the energy generation rates.
> $$
> \rd L = \rho \, \rd V_{\rm shell} \, (\varepsilon_{n} - \varepsilon_{\nu} + \varepsilon_{g}) = \rho \, \left( 4 \pi r^{2} \, \rd r \right) \, (\varepsilon_{n} - \varepsilon_{\nu} + \varepsilon_{g})
> $$
> Here, we ignore the energy lost to neutrinos ($\varepsilon_{\nu} = 0$), and we use the [[Thermodynamics#2nd Law of Thermodynamics]] to define the energy gained/lost from gravitational expansion/contraction ($\varepsilon_{g}$) as a heating rate ($-\td{Q}{t}$).
> $$
> \textbf{2nd Law:} \quad \rd Q = T \, \rd S \hRightarrow \varepsilon_{g} = -\td{Q}{t} = -T \td{S}{t}
> $$
> Substituting in these values and rearranging...
> $$
> \rd L = \left( \varepsilon_{n} - T \td{S}{t} \right) \, 4 \pi r^{2} \rho \, \rd r
> \hRightarrow \boxed{\td{L}{r} = 4 \pi r^{2} \rho \, \left( \varepsilon_{n} - T \td{S}{t} \right)}
> $$
...
$$
\left| \td{T}{r} \right|_{\rm actual} < \left| \td{T}{r} \right|_{\rm adiabatic} \hRightarrow 
\td{T}{r} = - \frac{3 \kappa_{\rm R}}{64 \pi \sigma} \frac{\rho L}{ r^{2} T^{3}} = -\frac{3 \kappa_{\rm R}}{16 \pi a c}\frac{\rho L}{ r^{2} T^{3}}
$$
...
> $$
> F = \sigma T^{4} \hRightarrow F_{\rm net} = \rd F = \sigma \left[ T^{4}(r) - T^{4} (r + \Delta r) \right] = - \sigma \td{\left( T^{4} \right)}{r} \, \Delta r
> $$
...
> $$
> F_{\rm net} = - \sigma \td{\left( T^{4} \right)}{r}  \, \Delta r = - \frac{4 \sigma T^{3}}{\kappa \rho} \td{T}{r} = - \frac{a c T^{3}}{\kappa \rho} \td{T}{r}
> $$
> Applying the net flux to the Luminosity relationship yields a result that is $3/4$ off from the exact answer.
> $$
> L(r) = 4 \pi r^{2} F(r) \hRightarrow L = - \frac{4 \pi a c r^{2} T^{3}}{\kappa \rho} \td{T}{r} \hRightarrow \td{T}{r} = - \frac{\kappa \rho L}{4 \pi a c r^{2} T^{3}}
> $$
> 
...
> $$
> F_{\rm net} = - \frac{c}{\rho \kappa_{\rm R}} \td{P_{\rm rad}}{r} = - \frac{c}{\rho \kappa_{\rm R}} \left( \frac{4}{3} a T^{3} \td{T}{r} \right) \hWhere \underbrace{P_{\rm rad} = \frac{1}{3} a T^{4}}_{\text{isotropic blackbody}}
> $$
> ...the Luminosity relationship yields:
> $$
> L(r) = 4 \pi r^{2} F(r) \hRightarrow L = - \frac{4 \pi r^{2} c}{\rho \kappa_{\rm R}} \left( \frac{4}{3} a T^{3} \td{T}{r} \right) \hRightarrow \boxed{\td{T}{r} = -\frac{3 \kappa_{\rm R}}{16 \pi a c}\frac{\rho L}{ r^{2} T^{3}}}
> $$
...
$$
\left| \td{T}{r} \right|_{\rm actual} \gtrsim \left| \td{T}{r} \right|_{\rm adiabatic} \hRightarrow 
\td{T}{r} = \left( 1 - \frac{1}{\gamma_{rad}} \right) \frac{T}{P} \td{P}{r}
$$
...
\end{aligned} \right.
\hRightarrow
\frac{P'_{1}}{P'_{2}} = \fpar{\rho'_{1}}{\rho'_{2}}^{\gamma_{\rm ad}} \underbrace{= \frac{P_{1}}{P_{2}}}_{\rm P\ equilibrium}
$$
$$\rho'_{2} = \rho_{1} \fpar{P_{2}}{P_{1}}^{1/\gamma}$$

The following mathematical steps are used to convert from working with pressures in favor of working with temperatures.

- Approximate $P_{2}$ in terms of $P_{1}$. $$P_{2} \approx P_{1} + \left. \td{P}{r} \right|_{r} \Delta r \hRightarrow \begin{aligned}[t] \rho'_{2} &= \rho_{1} \fpar{P_{2}}{P_{1}}^{1/\gamma_{\rm ad}} \\ &\approx \rho_{1} \left( 1 + \frac{1}{P_{1}} \td{P}{r} \Delta r \right)^{1/\gamma_{\rm ad}} \\ &\approx \rho_{1} \left( 1 + \frac{1}{\gamma_{\rm ad} P_{1}} \td{P}{r} \Delta r \right) \end{aligned}$$
- Approximate $\rho_{1}$ in terms of $\rho_{2}$. $$\rho_{2} \approx \rho_{1} + \left. \td{\rho}{r} \right|_{r} \Delta r$$
- Combine together with the condition for stability against convection. $$\begin{align} \rho'_{2} &> \rho_{2} \\ \rho_{1} \left( 1 + \frac{1}{\gamma_{\rm ad} P_{1}} \td{P}{r} (\Delta r) \right) &> \rho_{1} + \td{\rho}{r} (\Delta r) \\ \frac{\rho_{1}}{\gamma_{\rm ad} P_{1}} \td{P}{r} &> \td{\rho}{r} \end{align}$$
- Use the [[Thermodynamics#Ideal Gas Law]] to convert pressure into temperature. $$P = \fpar{\rho}{\mu m_{\rm p}} k_{\rm B} T \hRightarrow \begin{aligned}[t] \td{\rho}{r} &= \frac{\mu m_{\rm p}}{k_{\rm B}} \td{}{r} \fpar{P}{T} \\ \frac{\rho}{\gamma_{\rm ad} P} \td{P}{r} &> \frac{\mu m_{\rm p}}{k_{\rm B}} \left[ \frac{1}{T} \td{P}{r} - \frac{P}{T^{2}} \td{T}{r} \right] \\ \frac{1}{\gamma_{\rm ad}} \fpar{\mu m_{\rm p}}{k_{\rm B} T} \td{P}{r} &> \frac{\mu m_{\rm p}}{k_{\rm B}} \left[ \frac{1}{T} \td{P}{r} - \frac{P}{T^{2}} \td{T}{r} \right] \\ \frac{1}{\gamma_{\rm ad}} \td{P}{r} &> \td{P}{r} - \frac{P}{T} \td{T}{r} \\ \td{T}{r} &> \frac{T}{P} \left( 1 - \frac{1}{\gamma_{\rm ad}} \right) \td{P}{r} \equiv \left. \td{T}{r} \right|_{\rm adiabatic} \end{aligned}$$
...
\; \right\}
\hWhere
\boxed{ \; \left| \td{T}{r} \right|_{\rm ad} = \frac{T}{P} \left( 1 - \frac{1}{\gamma_{\rm ad}} \right) \td{P}{r} \; }
$$
...
> $$
> \left. \td{T}{r} \right|_{\rm rad}= - \frac{3 \, \kappa_{\rm R}}{16 \pi a c} \frac{\rho L}{r^{2} T^{3}}
> $$
> $| \rd T / \rd r |$ is large (and thus convective) when...
...
$$
\begin{alignat}{3}
	\td{T}{r} &= - \fpar{3 \kappa_{\rm R}}{16 \pi a c} \frac{\rho L}{ r^{2} T^{3}} &\hRightarrow \frac{T}{R} &\propto \frac{\rho L}{ R^{2} T^{3}} \propto \frac{M L}{R^{5} T^{3}} \\
	&&& \\
	\td{P}{r} &= -\frac{G M_{r} \rho}{r^{2}} &\hRightarrow \frac{P}{R} &\propto \frac{M \rho}{R^{2}} \propto \frac{M^{2}}{R^{5}}
\end{alignat}
$$
...
\hRightarrow 
\fpar{M}{R}^{4} \propto \frac{M L}{R^{4}}
\hRightarrow 
\boxed{L \propto M^{3}}
$$
